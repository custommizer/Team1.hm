                ...
                <div class="footer-content">
                    <div class="footer-links" id='links'>
                        <div class="footer-title">
                            <h2>Информация о компаний</h2>
                        </div>
                        <ul class="footer-list">
                            <li class="footer-item">
                                <p><span> H&M</span> — шведская компания, крупнейшая в Европе розничная сеть по торговле одеждой, штаб-квартиры которой находятся в Стокгольме и Нью-Йорке. H&M и его дочерние компании действуют в 71 стране мира с 4968 магазинов по состоянию на ноябрь 2018 года. </p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="sub-inner">
                        ...
                        <h2>Подпишитесь на нашу рассылку</h2>
                            ...
                            <div class="sub-input">
                                <input type="text" placeholder="Введи почту"/>
                                    <span>Войти</span>
                            </div>
                    </div>
                </div>
